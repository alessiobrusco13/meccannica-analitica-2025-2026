...
\chaptermark{Lagrange e principi variazionali}
...
Consideriamo l'ipotesi di vincoli ideali, per cui $\var{L^{(v)}} \geq 0$.\note{Le equazioni di Lagrange possono essere ricavate anche senza questa ipotesi attraverso i moltiplicatori di Lagrange} Segue necessariamente 
\begin{equation*}
...
\end{equation*}
ovvero $n$ equazioni scalari finite\note{non compaiono più variazioni infinitesime}. Queste sono le \emph{equazioni di Lagrange}, tuttavia non sono ancora poste in una formulazione utile. Introduciamo la seguente legge:
